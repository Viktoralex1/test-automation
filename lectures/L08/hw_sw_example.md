...
|---------|----------------------------------|---------------------------------|---------------|------------------|-------|
| 1.1     | Temperature button (SW2) press   | Temperature is printed in terminal | 23.0°C printed after button pressed | Pass | 1 min |
| 1.2     | Temperature timer                | Temperature is printed every 60 s or 60 s after last press | Temperature printed 60 s after last pressdown | Pass | 1 min |
| 1.3     | Temperature verification         | Displayed temperature matches room temp; increases when sensor is heated | | | |
| 1.4     | Temperature button debounce      | Repeated presses within 300 ms are ignored | | | |
| 2.1     | Toggle button verification       | LED blinks when pressed and stops when pressed again | | | |
| 2.2     | Toggle speed                     | LED blink frequency matches expected value (5 Hz) | | | |
| 2.3     | Toggle debounce                  | Repeated presses within 300 ms are ignored | | | |
| 3.1     | Watchdog verification            | System resets every 1024 ms when reset function removed | | | |
| 3.2     | Watchdog re-implementation       | System operates normally after restoring watchdog reset function | | | |
| 4.1     | Toggle-timer EEPROM verification | LED state persists across power cycles; ON stays ON, OFF stays OFF | | | |
